    ...
    >
      <div className="absolute inset-0 flex items-end justify-end bg-[#0a0a0a]">
        <video
          ...
          className="absolute bottom-0 right-0 w-auto h-[82%] max-w-[60%] object-contain"
          muted
          playsInline
          loop={slide.loop}
...
function HeroContent({
  ...
  return (
    <div className="absolute inset-0 z-20 pointer-events-none">
      <div className="absolute inset-x-0 top-[22%] md:top-[25%] flex items-start md:justify-start gap-3 md:gap-5 px-6 md:pl-[17%] md:pr-[3%] pointer-events-auto">
