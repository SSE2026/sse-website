...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    titleEn: "[Major Release] 460 Wh/kg anode-free battery unveiled — SSE's CloudChi 460-X unlocks new frontiers in extreme power",
    excerpt: '深安锂能发布 460Wh/kg 无负极固态电池——云驰 460-X，面向 eVTOL、人形机器人等极限动力场景。',
    excerptEn: 'SSE launches the CloudChi 460-X at 460 Wh/kg — its first anode-free cell aimed at extreme-power applications such as eVTOL and humanoid robotics.',
